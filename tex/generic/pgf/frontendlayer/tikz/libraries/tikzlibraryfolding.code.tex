...
%alternative dodecahedron: larger format possible, ordered faces, rotated for ease of reading
\def\tikzfoldingalternatedodecahedron#1[#2]#3;{%
  \begingroup%
    \tikzset{#2}%
    \tikz@lib@fold@pentagon
        {\scope[rotate=180]\tikz@lib@fold@face@I\endscope}
        {\tikz@lib@fold@pentagon
             {\scope[rotate=36]\tikz@lib@fold@face@F\endscope}
             {\tikz@lib@fold@cut@path}
             {\tikz@lib@fold@ear@path}
             {\tikz@lib@fold@path}
             {\tikz@lib@fold@cut@path}
             {\tikz@lib@fold@pentagon
                  {\tikz@lib@fold@face@A}
                  {\tikz@lib@fold@pentagon
                       {\scope[rotate=180]\tikz@lib@fold@face@D\endscope}
                       {\tikz@lib@fold@ear@path}
                       {\tikz@lib@fold@ear@path}
                       {\tikz@lib@fold@path}
                       {\tikz@lib@fold@cut@path}
                  ...
                  {\tikz@lib@fold@pentagon
                       {\scope[rotate=180]\tikz@lib@fold@face@E\endscope}
                       {\tikz@lib@fold@ear@path}
                       {\tikz@lib@fold@ear@path}
                       {\tikz@lib@fold@path}
                       {\tikz@lib@fold@cut@path}
                  ...
                  {\tikz@lib@fold@path}
                  {\tikz@lib@fold@pentagon
                       {\scope[rotate=180]\tikz@lib@fold@face@B\endscope}
                       {\tikz@lib@fold@ear@path}
                       {\tikz@lib@fold@ear@path}
                       {\tikz@lib@fold@path}
                       {\tikz@lib@fold@ear@path}
                  ...
                  {\tikz@lib@fold@pentagon
                       {\scope[rotate=180]\tikz@lib@fold@face@C\endscope}
                       {\tikz@lib@fold@ear@path}
                       {\tikz@lib@fold@ear@path}
                       {\tikz@lib@fold@path}
                       {\tikz@lib@fold@cut@path}
        ...
        {\tikz@lib@fold@pentagon
             {\tikz@lib@fold@face@L}
             {\tikz@lib@fold@pentagon
                  {\scope[rotate=180]\tikz@lib@fold@face@G\endscope}
                  {\tikz@lib@fold@cut@path}
                  {\tikz@lib@fold@ear@path}
                  {\tikz@lib@fold@path}
                  {\tikz@lib@fold@cut@path}
             ...
             {\tikz@lib@fold@pentagon
                  {\scope[rotate=180]\tikz@lib@fold@face@H\endscope}
                  {\tikz@lib@fold@cut@path}
                  {\tikz@lib@fold@cut@path}
                  {\tikz@lib@fold@path}
                  {\tikz@lib@fold@cut@path}
        ...
        {\tikz@lib@fold@path}
        {\tikz@lib@fold@pentagon
             {\scope[rotate=180]\tikz@lib@fold@face@J\endscope}
             {\tikz@lib@fold@cut@path}
             {\tikz@lib@fold@ear@path}
             {\tikz@lib@fold@path}
             {\tikz@lib@fold@cut@path}
        ...
        {\tikz@lib@fold@pentagon
             {\scope[rotate=180]\tikz@lib@fold@face@K\endscope}
             {\tikz@lib@fold@cut@path}
             {\tikz@lib@fold@ear@path}
             {\tikz@lib@fold@path}
             {\tikz@lib@fold@cut@path}
...
\def\tikzfoldingicosidodecahedron#1[#2]#3;{%
  \begingroup%
    ...
    {\tikz@lib@fold@triangle{\tikz@lib@fold@face@T}
      {\tikz@lib@fold@pentagon{\tikz@lib@fold@face@E}
        {\tikz@lib@fold@triangle{\tikz@lib@fold@face@U}
          {\tikz@lib@fold@ear@path}
          {\tikz@lib@fold@path}
    ...
    {\tikz@lib@fold@triangle{\tikz@lib@fold@face@AC}
      {\tikz@lib@fold@pentagon{\tikz@lib@fold@face@K}
        {\tikz@lib@fold@triangle{\tikz@lib@fold@face@AD}
          {\tikz@lib@fold@ear@path}
          {\tikz@lib@fold@path}
          {\tikz@lib@fold@pentagon{\tikz@lib@fold@face@L}
            {\tikz@lib@fold@triangle{\tikz@lib@fold@face@AE}
              {\tikz@lib@fold@cut@path}
              {\tikz@lib@fold@path}
              {\tikz@lib@fold@cut@path}
...
\def\tikzfoldingrhombicdodecahedron#1[#2]#3;{%
  \begingroup%
    ...
    {\tikz@lib@fold@squarerhombusl{\scope[rotate=-90]\tikz@lib@fold@face@H\endscope}
      ...
      {\tikz@lib@fold@squarerhombusl{\scope[rotate=90]\tikz@lib@fold@face@I\endscope}
        {\tikz@lib@fold@ear@path}
        {\tikz@lib@fold@ear@path}
        {\tikz@lib@fold@path}
        {\tikz@lib@fold@ear@path}
    ...
    {\tikz@lib@fold@squarerhombusr{\scope[rotate=180]\tikz@lib@fold@face@A\endscope}
      {\tikz@lib@fold@cut@path}
      {\tikz@lib@fold@cut@path}
      {\tikz@lib@fold@path}
      {\tikz@lib@fold@cut@path}
